...
//------------ Símbolo inicial de la gramática. Para análisis léxico no hace falta más
  ...
  static final public Symbol.Types asignable() throws ParseException {
    ...
    default:
      ...
      ;
                ...
                if (index == null)
                {
                        {if (true) return tablaSimbolos.getSymbol(token.image).type;}
                }
                else // Nuestro simbolo forma parte de un vector
                {
                        ...
                        {if (true) return element.baseType;}
                }
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Symbol.Types primario() throws ParseException {
    ...
    default:
      ...
      if (jj_2_4(2)) {
        ...
        case tID:
          token = jj_consume_token(tID);
                                         symbolType = tablaSimbolos.getSymbol(token.image).type;
          break;
        case tCONST_INT:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x8000,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x202000,0x0,0x8000,0x0,0x0,0x0,0x0,0x0,0x0,0x202000,0x200000,0x80000000,0x80000000,0x7e000000,0x7e000000,0x300000,0x300000,0x0,0x1c00000,0x1c00000,0x202000,0x2000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4e0,0x4e0,0x80000,0x0,0x4e0,0x80000,0x0,0x7800,0x40800c,0x80000,0x400000,0x80000,0x770302,0x80000,0x0,0x10,0x10,0x10,0x40f80c,0x4e0,0x40f80c,0x770302,0x2,0x1,0x1,0x0,0x0,0x0,0x0,0x4e0,0x0,0x0,0x770302,0x30000,0x740300,};
   }
